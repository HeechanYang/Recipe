package yang.springframework.recipe.bootstrap;

import org.springframework.context.ApplicationListener;
import org.springframework.context.event.ContextRefreshedEvent;
import org.springframework.stereotype.Component;
import org.springframework.transaction.annotation.Transactional;
import yang.springframework.recipe.models.*;
import yang.springframework.recipe.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("ripe Avocados", new BigDecimal(2), eachUom))
                ...
                .addIngredient(new Ingredient("freshly grated black pepper", new BigDecimal(1), dashUom))
                .addIngredient(new Ingredient("tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachUom));
